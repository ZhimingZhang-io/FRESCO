...
from fractal_ecg_encoder import FractalECGEncoder
...
class FractalECGCLIP(torch.nn.Module):
    def __init__(self, network_config):
        super(FractalECGCLIP, self).__init__()
        ...
        # 使用分形ECG编码器
        self.ecg_encoder = FractalECGEncoder(
            num_leads=12,
            seq_len=5000,
        ...
        self.proj_e = nn.Sequential(
            nn.Linear(512, self.proj_hidden),
    ...
    def ext_ecg_emb(self, ecg):
        ecg_emb = self.ecg_encoder(ecg)  # [B, 512]

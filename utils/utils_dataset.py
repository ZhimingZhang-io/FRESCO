...
if __name__ == '__main__':
    dataset = ECG_TEXT_Dsataset(data_path='/remote-home/hao.lu/Code/Yuting/ECG/CHASE_FOR_ICML-2026/MERL/pretrain', dataset_name='mimic')
    dataset = dataset.get_dataset(train_test='train')
    print(dataset[0]['ecg'].shape,type(dataset[0]['ecg']))